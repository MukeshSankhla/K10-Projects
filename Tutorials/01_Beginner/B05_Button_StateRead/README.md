...
This tutorial introduces **digital input sensing and user interaction** on the UNIHIKER K10. 

You will learn how the microcontroller monitors physical tactile push buttons, evaluates their binary electrical states (pressed vs. released), and responds dynamically in real time by controlling the onboard RGB LEDs.

### Expected Behavior
- When **Button A** is pressed and held: All 3 onboard LEDs light up **Green** (`0x00FF00`).
- When **Button B** is pressed and held: All 3 onboard LEDs light up **Blue** (`0x0000FF`).
- When **neither button is pressed**: The LEDs remain completely **OFF** (`0x000000`).
