...
| B14 | [`B14_SD_Card_Example`](./01_Beginner/B14_SD_Card_Example/) | Mounts the onboard MicroSD card, queries storage metrics, verifies file write/read cycles, and logs timestamped events. |
| B15 | [`B15_Mic_CaptureToSD`](./01_Beginner/B15_Mic_CaptureToSD/) | Samples live audio from the onboard I2S MEMS microphone and saves high-fidelity 16kHz stereo WAV recordings directly to the SD card. |
| B16 | [`B16_Audio_PlayFromSD`](./01_Beginner/B16_Audio_PlayFromSD/) | Streams and plays WAV audio files from the MicroSD card through the onboard I2S DAC amplifier and speaker with button controls. |
| B17 | [`B17_Audio_Repeater`](./01_Beginner/B17_Audio_Repeater/) | Implements an interactive talking voice repeater: records speech from the microphone to SD and immediately replays it through the speaker. |
| B18 | [`B18_Camera_CaptureAndView`](./01_Beginner/B18_Camera_CaptureAndView/) | Real-time live camera viewfinder with shutter button saving BMP snapshots to SD card, and playback mode viewing captured photos on screen. |
